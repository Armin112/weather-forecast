...
const WeatherContent = ({ weather}) => {
    return (
        <div className="ui segment center aligned">
            ...
            <img className="ui mini image" src="https://img.icons8.com/metro/26/000000/thermometer.png" alt="Temperature"/>Temperature</h4>
            <img className="ui centered tiny image" src={weather.get('condition').get('icon')} alt="Condition"/>
            <h2>{weather.get('temp_c')}&deg;C &nbsp;&nbsp;|&nbsp;&nbsp; {weather.get('temp_f')}&deg;F</h2>
            <h4>Humidity: {weather.get('humidity')}%</h4>
            <h4 className="ui horizontal divider header">
            <img className="ui mini image" src="https://img.icons8.com/metro/26/000000/wind-gauge.png" alt="Wind"/>Wind</h4>
            ...
            <h4 className="ui horizontal divider header">
            <img className="ui mini image" src="https://img.icons8.com/metro/26/000000/atmospheric-pressure.png" alt="Pressure"/>Pressure</h4>
